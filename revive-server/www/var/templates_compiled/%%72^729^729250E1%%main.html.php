...
" target="help"><?php echo $this->_plugins['function']['t'][0](['str' => 'Help'], $this);?>
</a></li>
<?php endif; ?>
...
" target="_blank"><?php echo $this->_plugins['function']['t'][0](['str' => 'Support'], $this);?>
</a></li>
<?php endif; ?>

<?php if ($this->_tpl_vars['buttonLogout']): ?>
        <li class="buttonLogout"><a href="<?php echo $this->_tpl_vars['adminWebPath']; ?>
logout.php"><?php echo $this->_plugins['function']['t'][0](['str' => 'Logout'], $this);?>
</a></li>
<?php endif; ?>

<?php if ($this->_tpl_vars['buttonStartOver']): ?>
        <li class="buttonStartOver"><a href="index.php"><?php echo $this->_plugins['function']['t'][0](['str' => 'StartOver'], $this);?>
</a></li>
<?php endif; ?>
    </ul>
    </div>
...
'); return false;">
            <input type="text" name="keyword" class="search" accesskey="<?php echo $this->_plugins['function']['t'][0](['key' => 'Search'], $this);?>
            ...
            <div class="accountsPanel">
              ...
              <div class="switchMiddle">
                <div class="switchMiddleBody">
	                <div class="label">
                      <?php echo $this->_plugins['function']['t'][0](['key' => 'SwitchTo'], $this);?>
...
<script type='text/javascript'>
<!--
    alert('<?php echo $this->_plugins['function']['t'][0](['str' => 'MaintenanceNotActive','escape' => 'javascript'], $this);?>
');
...
<?php if ($this->_tpl_vars['loaderDelay'] >= 0): ?>
<?php echo '
<script>
...
<?php echo $this->_tpl_vars['loaderDelay']; ?>
<?php echo ')
    });
</script>
'; ?>
