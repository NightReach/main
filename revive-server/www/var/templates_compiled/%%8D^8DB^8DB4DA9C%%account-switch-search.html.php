<?php /* Smarty version 2.6.18, created on 2025-12-08 15:56:29
...
"><?php echo $this->_plugins['function']['boldSearchPhrase'][0](['text' => $this->_tpl_vars['accountName'],'search' => $this->_tpl_vars['query']], $this);?>
</a>
    </li>
...
"><?php echo $this->_plugins['function']['boldSearchPhrase'][0](['text' => $this->_tpl_vars['accountName'],'search' => $this->_tpl_vars['query']], $this);?>
    ...
    <?php if (isset ( $this->_tpl_vars['remainingCounts'][$this->_tpl_vars['groupName']] )): ?>
      <li class="inopt more" title="<?php echo $this->_plugins['function']['t'][0](['str' => 'UseSearchBoxToFindMoreAccounts'], $this);?>
