<?php /* Smarty version 2.6.18, created on 2025-12-09 10:52:56
...
<head>
  ...
  <title><?php echo $this->_plugins['function']['t'][0](['str' => 'CampaignOverview'], $this);?>
</title>
...
"><?php echo $this->_plugins['function']['t'][0](['str' => 'CampaignGoTo'], $this);?>
</a></div>
    <!-- end of normal view -->
    <?php else: ?>
	...
	<div class="widgetListWrapper widgetContainer">
	    <ul class="widgetList campaignNoItems">
	        <li><?php echo $this->_plugins['function']['t'][0](['str' => 'CampaignNoDataTimeSpan'], $this);?>
</li>
	    </ul>
	</div>
	<div><a class="site-link" target="_top" href="<?php echo $this->_tpl_vars['siteUrl']; ?>
"><?php echo $this->_plugins['function']['t'][0](['str' => 'CampaignSetUp'], $this);?>
</a></div>
    ...
    <div class="widgetListWrapper widgetContainer">
        <ul class="widgetList campaignList">
            <?php if ($this->_tpl_vars['isAdmin'] == true): ?>
                <?php echo $this->_plugins['function']['t'][0](['str' => 'CampaignNoRecordsAdmin'], $this);?>

            <?php else: ?>
                <?php echo $this->_plugins['function']['t'][0](['str' => 'CampaignNoRecords'], $this);?>
...
<?php else: ?>
	...
	<div class="widgetListWrapper widgetContainer">
	    <ul class="widgetList campaignAuditNotActivated">
	       <?php echo $this->_plugins['function']['t'][0](['str' => 'CampaignAuditNotActivated'], $this);?>
