<?php /* Smarty version 2.6.18, created on 2025-12-09 10:27:33
...
<div class='tableWrapper'>
    <div class='tableHeader'>
        <ul class='tableActions'>
            <li>
                <a href='affiliate-edit.php' class='inlineIcon iconWebsiteAdd'><?php echo $this->_plugins['function']['t'][0](['str' => 'AddNewAffiliate'], $this);?>
</a>
            </li>
...
<?php echo $this->_plugins['function']['t'][0](['str' => 'ConfirmDeleteAffiliates'], $this);?>
<?php echo '")) {
...
'>
                    <?php echo $this->_plugins['function']['ox_column_title'][0](['item' => 'name','order' => 'up','default' => 1,'str' => 'Name','url' => "website-index.php"], $this);?>

                </th>
                <th class='<?php echo $this->_plugins['function']['ox_column_class'][0](['item' => 'updated','order' => 'up','default' => 0], $this);?>
'>
                    <?php echo $this->_plugins['function']['ox_column_title'][0](['item' => 'updated','order' => 'up','default' => 0,'str' => 'Updated','url' => "website-index.php"], $this);?>

                </th>
                <?php if ($this->_tpl_vars['showAdDirect']): ?>
                <th>
                    <?php echo $this->_plugins['function']['t'][0](['str' => 'AdvertiserSignup'], $this);?>
            ...
            <tr class='even'>
                <td colspan='<?php if ($this->_tpl_vars['showAdDirect']): ?>4<?php else: ?>3<?php endif; ?>' class="hasPanel">
                    <div class='tableMessage'>
                        <div class='panel'>
                            <?php echo $this->_plugins['function']['t'][0](['str' => 'NoAffiliates'], $this);?>
...
' class='inlineIcon iconWebsite'><?php echo ((is_array($_tmp=$this->_tpl_vars['affiliate']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')); ?>
                    ...
                    <?php echo $this->_plugins['function']['ox_entity_id'][0](['type' => 'Website','id' => $this->_tpl_vars['key']], $this);?>

                </td>
                <td>
                    <?php echo $this->_plugins['function']['ox_column_updated'][0](['updated' => $this->_tpl_vars['affiliate']['updated']], $this);?>
...
' class='inlineIcon iconZones'><?php echo $this->_plugins['function']['t'][0](['str' => 'Zones'], $this);?>
</a>
                        </li>
                        <li>
                            <a href='affiliate-channels.php?affiliateid=<?php echo $this->_tpl_vars['key']; ?>
' class='inlineIcon iconTargetingChannels'><?php echo $this->_plugins['function']['t'][0](['str' => 'Channels'], $this);?>
</a>
                        </li>
                    </ul>
                </td>
