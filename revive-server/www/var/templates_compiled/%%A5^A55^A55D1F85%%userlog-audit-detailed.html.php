<?php /* Smarty version 2.6.18, created on 2025-12-10 18:56:09
...
<div>
    <p class="tableTitle"><?php echo $this->_plugins['function']['t'][0](['str' => 'Event Details'], $this);?>
</p>
    <table class="data-grid table">
        <tbody>
            <tr class="odd">
                <td style="width: 30%"><?php echo $this->_plugins['function']['t'][0](['str' => 'ID'], $this);?>
</td>
                <td>#<?php echo $this->_tpl_vars['aAuditDetail']['contextid']; ?>
</td>
            </tr>
            <tr class="even">
                <td style="width: 30%"><?php echo $this->_plugins['function']['t'][0](['str' => 'Name'], $this);?>
</td>
            ...
            <tr class="odd">
                <td style="width: 30%;"><?php echo $this->_plugins['function']['t'][0](['str' => 'Type'], $this);?>
</td>
                <td style="text-align:left;"><?php echo $this->_tpl_vars['aAuditDetail']['contextDescription']; ?>
</td>
            </tr>
            <tr class="even">
                <td class="label"><?php echo $this->_plugins['function']['t'][0](['str' => 'Action'], $this);?>
</td>
                <td style="text-align:left;"><?php echo $this->_plugins['function']['t'][0](['str' => $this->_tpl_vars['aAuditDetail']['action']], $this);?>
</td>
            </tr>
            <tr class="odd">
                <td class="label"><?php echo $this->_plugins['function']['t'][0](['str' => 'Username'], $this);?>
</td>
    ...
    <p class="tableTitle"><?php echo $this->_plugins['function']['t'][0](['str' => 'Event History'], $this);?>
</p>
    <table class="data-grid table">
	    <thead>
	        <tr class="header">
	            <th><?php echo $this->_plugins['function']['t'][0](['str' => 'Parameter'], $this);?>
</th>
	            <th><?php echo $this->_plugins['function']['t'][0](['str' => 'Value'], $this);?>
</th>
	        </tr>
	    </thead>
	    <tbody>
...
?>
            <?php echo smarty_function_cycle(['values' => 'odd,even','assign' => 'rowClass'], $this);?>
...
">View</a></td>
    ...
    <input type="Button" name="" value="<?php echo $this->_plugins['function']['t'][0](['str' => 'ReturnAuditTrail'], $this);?>
