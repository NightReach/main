<?php /* Smarty version 2.6.18, created on 2025-12-09 10:26:34
...
'>
    ...
    <table border='0' width='100%' cellpadding='0' cellspacing='0'>
        <tr><td height='25' colspan='3'><b><?php echo $this->_plugins['function']['t'][0](['str' => 'ChooseBanner'], $this);?>
</b></td></tr>
        <tr><td height='25'>
...
";this.form.submit();' <?php echo $this->_plugins['function']['tabindex'][0]([], $this);?>
 >
            <?php echo smarty_function_html_options(['options' => $this->_tpl_vars['bannerTypes'],'selected' => $this->_tpl_vars['bannerType']], $this);?>
...
<span class='tab-r'><?php echo $this->_plugins['function']['t'][0](['str' => 'Warning'], $this);?>
:</span><br />
<?php echo $this->_plugins['function']['t'][0](['str' => 'WarnChangeZoneType'], $this);?>
...
<span class='tab-s'> <?php echo $this->_plugins['function']['t'][0](['str' => 'Notice'], $this);?>
</span><br />
<?php echo $this->_plugins['function']['t'][0](['str' => 'WarnChangeBannerSize'], $this);?>
...
<?php echo $this->_plugins['function']['t'][0](['str' => 'WarnBannerReadonly'], $this);?>
