...
;
    ...
    var strCampaignWarningNoTargetMessage = '<?php echo $this->_plugins['function']['t'][0](['str' => 'CampaignWarningNoTarget','escape' => 'javascript'], $this);?>
';
    var strCampaignWarningRemnantNoWeight = '<?php echo $this->_plugins['function']['t'][0](['str' => 'CampaignWarningRemnantNoWeight','escape' => 'javascript'], $this);?>
';
    var strCampaignWarningEcpmNoRevenue = '<?php echo $this->_plugins['function']['t'][0](['str' => 'CampaignWarningEcpmNoRevenue','escape' => 'javascript'], $this);?>
';
    var strCampaignWarningOverrideNoWeight = '<?php echo $this->_plugins['function']['t'][0](['str' => 'CampaignWarningOverrideNoWeight','escape' => 'javascript'], $this);?>
';
