...
.gif' width='16' height='16' border='0' align='absmiddle'>
        <?php if ($this->_tpl_vars['configLocked']): ?><?php echo $this->_plugins['function']['t'][0](['str' => 'EditConfigNotPossible'], $this);?>
<?php else: ?><?php echo $this->_plugins['function']['t'][0](['str' => 'EditConfigPossible'], $this);?>
<?php endif; ?>
    </div>
    <?php endif; ?>
<?php endif; ?>
...
<?php if ($this->_tpl_vars['oxInstalled']): ?>
    <?php if ($this->_tpl_vars['disableSubmit']): ?>
        <br /><br /><input type="submit" name="submitsettings" value="<?php echo $this->_plugins['function']['t'][0](['str' => 'SaveChanges'], $this);?>
