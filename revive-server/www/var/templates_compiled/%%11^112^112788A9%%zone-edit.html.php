<?php /* Smarty version 2.6.18, created on 2025-12-09 10:27:50
...
'><?php echo $this->_plugins['function']['t'][0](['str' => 'AddNewZone_Key'], $this);?>
</a>&nbsp;&nbsp;
...
:</span><br />
        <?php echo $this->_plugins['function']['t'][0](['str' => 'WarnChangeZoneSize'], $this);?>
...
/images/errormessage.gif' align='absmiddle'>
            <span class='tab-r'><?php echo $this->_plugins['function']['t'][0](['str' => 'ErrorEditingZone'], $this);?>
</span><br><br>";
            <?php echo $this->_plugins['function']['t'][0](['str' => 'UnableToChangeZone'], $this);?>
