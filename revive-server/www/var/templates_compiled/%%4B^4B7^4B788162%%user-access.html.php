<?php /* Smarty version 2.6.18, created on 2025-12-09 10:56:21
...
<table id="user-access-table" width="100%" cellspacing="0" cellpadding="0" border="0">
  <thead>
    ...
    <?php if ($this->_tpl_vars['sso']): ?>
      <td class="first" style="width: 25%"><?php echo $this->_plugins['function']['t'][0](['str' => 'EMail'], $this);?>
</td>
    <?php else: ?>
      <td class="first" style="width: 10%"><?php echo $this->_plugins['function']['t'][0](['str' => 'Username'], $this);?>
</td>
      <td style="width: 25%"><?php echo $this->_plugins['function']['t'][0](['str' => 'EMail'], $this);?>
</td>
    <?php endif; ?>
      <td style="width: 20%"><?php echo $this->_plugins['function']['t'][0](['str' => 'ContactName'], $this);?>
</td>
      <td style="width: 15%"><?php echo $this->_plugins['function']['t'][0](['str' => 'LastLoggedIn'], $this);?>
</td>
      <td style="width: 15%"><?php echo $this->_plugins['function']['t'][0](['str' => 'DateLinked'], $this);?>
</td>
  ...
  <?php echo smarty_function_cycle(['name' => 'row','values' => "even,odd",'assign' => 'rowType'], $this);?>

  <?php $_from = $this->_tpl_vars['users']['aUsers']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['user']):
?>
    <?php echo smarty_function_cycle(['name' => 'row','assign' => 'rowType'], $this);?>
...
<?php endif; ?>"><?php echo ((is_array($_tmp=$this->_tpl_vars['user']['email_address'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
      ...
      <?php endif; ?>
        ...
        <td><?php echo ((is_array($_tmp=$this->_tpl_vars['user']['date_last_login'])) ? $this->_run_mod_handler('utc_to_local', true, $_tmp) : $this->_plugins['modifier']['utc_to_local'][0]($_tmp)); ?>
</td>
        <td><?php echo ((is_array($_tmp=$this->_tpl_vars['user']['date_created'])) ? $this->_run_mod_handler('utc_to_local', true, $_tmp) : $this->_plugins['modifier']['utc_to_local'][0]($_tmp)); ?>
</td>
        <td class="last">
...
<?php if ($this->_tpl_vars['entityIdName']): ?>&amp;<?php echo $this->_tpl_vars['entityIdName']; ?>
=<?php echo $this->_tpl_vars['entityIdValue']; ?>
<?php endif; ?>" class="permissions" style="padding-right: 10px"><?php echo $this->_plugins['function']['t'][0](['str' => 'Permissions'], $this);?>
</a>
          <a href="<?php echo $this->_tpl_vars['unlinkPage']; ?>
?userid=<?php echo $this->_tpl_vars['user']['user_id']; ?>
<?php if ($this->_tpl_vars['entityIdName']): ?>&amp;<?php echo $this->_tpl_vars['entityIdName']; ?>
=<?php echo $this->_tpl_vars['entityIdValue']; ?>
<?php endif; ?>&amp;<?php echo $this->_plugins['function']['rv_add_session_token'][0]([], $this);?>
" class="unlink<?php if ($this->_tpl_vars['user']['toDelete']): ?> unlink-last<?php else: ?> unlink-normal<?php endif; ?>"><?php echo $this->_plugins['function']['t'][0](['str' => 'Remove'], $this);?>
</a>
        </td>
      </tr>
