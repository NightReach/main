<?php /* Smarty version 2.6.18, created on 2025-12-09 11:15:40
...
<tr>
  ...
  <td colspan='3'>
    <table>
      <tr>
        <td>
          <b><?php echo $this->_plugins['function']['t'][0](['str' => 'ColumnName'], $this);?>
</b>
        </td>
        <td>
          &nbsp;
        ...
        <td>
          <b><?php echo $this->_plugins['function']['t'][0](['str' => 'ShowColumn'], $this);?>
</b>
        </td>
        <td>
          &nbsp;
        ...
        <td>
          <b><?php echo $this->_plugins['function']['t'][0](['str' => 'CustomColumnName'], $this);?>
</b>
        </td>
        <td>
          &nbsp;
        ...
        <td>
          <b><?php echo $this->_plugins['function']['t'][0](['str' => 'ColumnRank'], $this);?>
</b>
        </td>
      </tr>
