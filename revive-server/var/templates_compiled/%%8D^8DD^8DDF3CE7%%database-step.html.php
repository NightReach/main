...
<div class="install-wizard">
  <div class="dbStep">
    ...
    <div class="content">
      ...
      <h2><?php echo $this->_plugins['function']['t'][0](['str' => 'DbUpgradeTitle'], $this);?>
</h2>
      <p><?php echo $this->_plugins['function']['t'][0](['str' => 'DbUpgradeIntro'], $this);?>
</p>
      <?php else: ?>
      <h2><?php echo $this->_plugins['function']['t'][0](['str' => 'DbSetupTitle'], $this);?>
</h2>
      <p><?php echo $this->_plugins['function']['t'][0](['str' => 'DbSetupIntro'], $this);?>
</p>
      <?php endif; ?>
