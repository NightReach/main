<?php /* Smarty version 2.6.18, created on 2025-12-08 14:47:59
...
/images/login-welcome.gif">&nbsp;&nbsp;</td>
            <td width="100%" >
                <span class="tab-s"><?php echo $this->_plugins['function']['t'][0](['str' => 'WelcomeTo'], $this);?>
 <?php echo ((is_array($_tmp=$this->_tpl_vars['appName'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</span><br />
                <span class="install"><?php echo $this->_plugins['function']['t'][0](['str' => 'EnterUsername'], $this);?>
</span><br />
        ...
        <tr>
            ...
            <td>
                <table cellpadding="0" cellspacing="0" border="0">
                    <tr height="24">
                        <td><?php echo $this->_plugins['function']['t'][0](['str' => 'Username'], $this);?>
:&nbsp;</td>
                        <td><input class="flat" type="text" name="username" id="username" autocomplete="username"<?php echo $this->_plugins['function']['tabindex'][0]([], $this);?>
 /></td>
                    </tr>
                    <tr height="24">
                        <td><?php echo $this->_plugins['function']['t'][0](['str' => 'Password'], $this);?>
:&nbsp;</td>
                        <td><input class="flat" type="password" name="password" id="password" autocomplete="current-password"<?php echo $this->_plugins['function']['tabindex'][0]([], $this);?>
 /></td>
                    </tr>
                    <tr height="24">
                        <td>&nbsp;</td>
                        <td><input type="submit" name="login" id="login" value="<?php echo $this->_plugins['function']['t'][0](['str' => 'Login'], $this);?>
"<?php echo $this->_plugins['function']['tabindex'][0]([], $this);?>
 /></td>
                    </tr>
                </table>
                <img class="break" src="<?php echo ((is_array($_tmp=$this->_tpl_vars['assetPath'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
/images/break-el.gif" width="400" height="1" vspace="8" /><br />
                <a href="password-recovery.php"><?php echo $this->_plugins['function']['t'][0](['str' => 'ForgotPassword'], $this);?>
</a>
            </td>
        </tr>
    </table>
