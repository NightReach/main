<?php /* Smarty version 2.6.18, created on 2025-12-08 14:45:05
         compiled from /Users/kartik/Documents/NightReach/main/nightreach/revive-server/lib/templates/admin/form/element-raw.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'oa_form_input_attributes', '/Users/kartik/Documents/NightReach/main/nightreach/revive-server/lib/templates/admin/form/element-raw.html', 15, false),array('function', 'html_options', '/Users/kartik/Documents/NightReach/main/nightreach/revive-server/lib/templates/admin/form/element-raw.html', 25, false),array('modifier', 'escape', '/Users/kartik/Documents/NightReach/main/nightreach/revive-server/lib/templates/admin/form/element-raw.html', 21, false),array('modifier', 'cat', '/Users/kartik/Documents/NightReach/main/nightreach/revive-server/lib/templates/admin/form/element-raw.html', 28, false),)), $this); ?>
...
</span><?php endif; ?><input <?php echo $this->_plugins['function']['oa_form_input_attributes'][0](['elem' => $this->_tpl_vars['elem'],'parent' => $this->_tpl_vars['parent']], $this);?>
...
<?php elseif ($this->_tpl_vars['elem']['type'] == 'textarea'): ?>
  <?php if ($this->_tpl_vars['elem']['prefix']): ?><span class="affix prefix"><?php echo $this->_tpl_vars['elem']['prefix']; ?>
</span><?php endif; ?><textarea <?php echo $this->_plugins['function']['oa_form_input_attributes'][0](['elem' => $this->_tpl_vars['elem'],'parent' => $this->_tpl_vars['parent']], $this);?>
...
<?php elseif ($this->_tpl_vars['elem']['type'] == 'select'): ?>
  <?php if ($this->_tpl_vars['elem']['prefix']): ?><span class="affix prefix"><?php echo $this->_tpl_vars['elem']['prefix']; ?>
</span><?php endif; ?><select <?php echo $this->_plugins['function']['oa_form_input_attributes'][0](['elem' => $this->_tpl_vars['elem'],'parent' => $this->_tpl_vars['parent']], $this);?>
 >
  <?php echo smarty_function_html_options(['options' => $this->_tpl_vars['elem']['options'],'selected' => $this->_tpl_vars['elem']['value']], $this);?>
