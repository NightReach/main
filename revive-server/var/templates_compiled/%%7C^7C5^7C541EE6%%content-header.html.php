...
'>
                  <span><?php echo $this->_plugins['function']['t'][0](['str' => 'Help'], $this);?>
</span>
              </a>
          </li>
          <?php endif; ?>
          ...
          <li class='alignRight'>
              <?php ob_start(); ?><?php echo $this->_plugins['function']['t'][0](['str' => 'Actions'], $this);?>
...
unset($_smarty_tpl_vars);
 ?>
          ...
          <li class='alignRight'>
              <?php ob_start(); ?><?php echo $this->_plugins['function']['t'][0](['str' => 'Shortcuts'], $this);?>
<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('linksTitle', ob_get_contents());ob_end_clean(); ?>
              <?php $_smarty_tpl_vars = $this->_tpl_vars;
