<?php /* Smarty version 2.6.18, created on 2025-12-08 14:45:05
         compiled from /Users/kartik/Documents/NightReach/main/nightreach/revive-server/lib/templates/admin/form/elements.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 't', '/Users/kartik/Documents/NightReach/main/nightreach/revive-server/lib/templates/admin/form/elements.html', 51, false),array('function', 'cycle', '/Users/kartik/Documents/NightReach/main/nightreach/revive-server/lib/templates/admin/form/elements.html', 77, false),array('block', 'oa_form_element', '/Users/kartik/Documents/NightReach/main/nightreach/revive-server/lib/templates/admin/form/elements.html', 80, false),array('modifier', 'cat', '/Users/kartik/Documents/NightReach/main/nightreach/revive-server/lib/templates/admin/form/elements.html', 87, false),array('modifier', 'default', '/Users/kartik/Documents/NightReach/main/nightreach/revive-server/lib/templates/admin/form/elements.html', 113, false),array('modifier', 'escape', '/Users/kartik/Documents/NightReach/main/nightreach/revive-server/lib/templates/admin/form/elements.html', 113, false),)), $this); ?>
...
<?php if ($this->_tpl_vars['_e']['type'] == 'controls'): ?>
      ...
      <?php if ($this->_tpl_vars['form']['hasRequiredFields'] && ! $this->_tpl_vars['form']['frozen']): ?>
        <span style="margin-left: 7px; float: right;">
            <span style="font-size:80%; color: red">*</span> <span style="font-size:80%; color:#7f7f7f;"><?php echo $this->_plugins['function']['t'][0](['str' => 'RequiredFieldLegend'], $this);?>
</span>
        </span>
      <?php endif; ?>
...
<?php if ($this->_tpl_vars['_e']['type'] == 'group'): ?>
 ...
 <?php if ($this->_tpl_vars['_e']['required']): ?><font color="red">*</font><?php endif; ?></td>
    ...
    <?php echo smarty_function_cycle(['name' => 'gsep','advance' => false,'values' => $this->_tpl_vars['_e']['separator'],'reset' => true,'print' => false], $this);?>
...
?>
        <?php if ($this->_tpl_vars['groupItem']['type'] == 'group'): ?>
            <?php $this->_tag_stack[] = array('oa_form_element', array('elem' => $this->_tpl_vars['groupItem'],'parent' => $this->_tpl_vars['_e'])); $_block_repeat=true;$this->_plugins['block']['oa_form_element'][0]($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?><?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['oa_form_element'][0]($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
        <?php else: ?>
...
unset($_smarty_tpl_vars);
 ?><?php if ($this->_tpl_vars['groupItem']['required'] && ! $this->_tpl_vars['groupItem']['label']): ?><font color="red">*</font><?php endif; ?>
            ...
            <?php endif; ?>
        <?php endif; ?>
        <?php if ($this->_tpl_vars['_e']['separator']): ?><?php echo smarty_function_cycle(['name' => 'gsep','values' => $this->_tpl_vars['_e']['separator']], $this);?>
